...
public class ElitisticListPopulation_ESTest extends ElitisticListPopulation_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 233, 233);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test03()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(17, 17);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 2097, 0.0);
      double double0 = elitisticListPopulation0.getElitismRate();
  ...
  public void test06()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 2097, 0.0);
      try { 
        elitisticListPopulation0.setElitismRate(2097);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setElitismRate((-498.37239069));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-498.372)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 2473, (-1976.29630065836));
        fail("Expecting exception: IllegalArgumentException");
