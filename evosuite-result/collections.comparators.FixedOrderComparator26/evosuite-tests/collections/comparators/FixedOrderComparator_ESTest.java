...
public class FixedOrderComparator_ESTest extends FixedOrderComparator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior(137);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual("Unrecognised value for unknown behaviour flag", object0);
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test07()  throws Throwable  {
      ...
      int int0 = fixedOrderComparator0.compare(2, fixedOrderComparator0);
  ...
  public void test08()  throws Throwable  {
      ...
      fixedOrderComparator0.add(object0);
      fixedOrderComparator0.setUnknownObjectBehavior(1);
      int int0 = fixedOrderComparator0.compare(object0, 1);
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      fixedOrderComparator0.setUnknownObjectBehavior(0);
      int int0 = fixedOrderComparator0.compare(1, object0);
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare(object0, 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add(" not known to ");
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(linkedList0);
      boolean boolean0 = fixedOrderComparator0.addAsEqual(" not known to ", " not known to ");
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual(linkedList0, integer0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior((-387));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test16()  throws Throwable  {
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator();
      fixedOrderComparator0.setUnknownObjectBehavior(1);
      fixedOrderComparator0.compare("%}%f+3(x o", "%}%f+3(x o");
      Object object0 = new Object();
      // Undeclared exception!
      try { 
        fixedOrderComparator0.add(object0);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior(2897);
        fail("Expecting exception: UnsupportedOperationException");
