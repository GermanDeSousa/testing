...
public class ElitisticListPopulation_ESTest extends ElitisticListPopulation_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(225, 0.07490822288864472);
  ...
  public void test01()  throws Throwable  {
      ...
      List<Integer> list0 = BinaryChromosome.randomBinaryRepresentation(112);
      DummyListChromosome dummyListChromosome0 = new DummyListChromosome(list0);
      linkedList0.add((Chromosome) dummyListChromosome0);
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 2937, Double.NaN);
  ...
  public void test02()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(2225, 0.0);
  ...
  public void test04()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(86, 0.0);
      List<Chromosome> list0 = elitisticListPopulation0.getChromosomes();
      ElitisticListPopulation elitisticListPopulation1 = null;
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list0, (-4035), 3479.77386484);
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 1740, 1740);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test06()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 266, 266);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(898, (-1899.6090716721014));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-1,899.609)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(2225, 0.0);
      try { 
        elitisticListPopulation0.setElitismRate(2225);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test11()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(57, 0.0);
      try { 
        elitisticListPopulation0.setElitismRate((-2970.19548579));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-2,970.195)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
