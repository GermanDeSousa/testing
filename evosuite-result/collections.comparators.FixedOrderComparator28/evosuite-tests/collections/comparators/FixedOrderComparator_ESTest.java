...
public class FixedOrderComparator_ESTest extends FixedOrderComparator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior(513);
  ...
  public void test06()  throws Throwable  {
      Object[] objectArray0 = new Object[6];
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      boolean boolean0 = fixedOrderComparator0.add(objectArray0[5]);
      assertEquals(2, fixedOrderComparator0.getUnknownObjectBehavior());
  ...
  public void test11()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      fixedOrderComparator0.setUnknownObjectBehavior(0);
      int int0 = fixedOrderComparator0.compare(0, object0);
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      fixedOrderComparator0.setUnknownObjectBehavior(0);
      int int0 = fixedOrderComparator0.compare(objectArray0[2], "collections.comparators.FixedOrderComparator");
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals(1, int0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare(objectArray0[0], 2);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual(2, 2);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test21()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      fixedOrderComparator0.setUnknownObjectBehavior(1);
      int int0 = fixedOrderComparator0.compare(objectArray0[2], "cllections.comparatrs.FixedOrderComaratr");
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
