...
public class ElitisticListPopulation_ESTest extends ElitisticListPopulation_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(219, 1.0);
      Integer[] integerArray0 = new Integer[0];
      DummyBinaryChromosome dummyBinaryChromosome0 = new DummyBinaryChromosome(integerArray0);
      List<Integer> list0 = BinaryChromosome.randomBinaryRepresentation(1722);
  ...
  public void test01()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(703, 0.0);
      Population population0 = elitisticListPopulation0.nextGeneration();
      assertNotSame(population0, elitisticListPopulation0);
  }
  ...
  public void test04()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(238, 1.0);
      Integer[] integerArray0 = new Integer[0];
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, (-962), (-962));
  ...
  public void test08()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(435, 435);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(239, 0.0);
      double double0 = elitisticListPopulation0.getElitismRate();
  ...
  public void test12()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(3047, 0.0);
      try { 
        elitisticListPopulation0.setElitismRate(3047);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test13()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(219, 1.0);
      try { 
        elitisticListPopulation0.setElitismRate((-1789.0898617598962));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-1,789.09)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
