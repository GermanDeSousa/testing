...
public class FixedOrderComparator_ESTest extends FixedOrderComparator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior(1591);
  ...
  public void test04()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator();
      fixedOrderComparator0.setUnknownObjectBehavior(0);
      fixedOrderComparator0.compare(objectArray0[1], "i9'MVuT_[");
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Attempting to compare unknown object java.lang.Object@1d78f4f
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      boolean boolean0 = fixedOrderComparator0.add(2);
      assertEquals(2, fixedOrderComparator0.getUnknownObjectBehavior());
      assertTrue(boolean0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator();
      fixedOrderComparator0.setUnknownObjectBehavior(1);
      fixedOrderComparator0.compare("Z^d_$s)_g&.o", objectArray0[1]);
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior((-1));
        fail("Expecting exception: UnsupportedOperationException");
  ...
  public void test10()  throws Throwable  {
      ...
      fixedOrderComparator0.setUnknownObjectBehavior(1);
      int int0 = fixedOrderComparator0.compare(object0, "Z^d_$s)_g&.o");
      assertTrue(fixedOrderComparator0.isLocked());
      assertEquals((-1), int0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare(objectArray0[0], "\"tlh40");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Attempting to compare unknown object \"tlh40
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // java.lang.Object@48a93764 not known to collections.comparators.FixedOrderComparator@1
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test20()  throws Throwable  {
      ...
      linkedList0.add("");
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(linkedList0);
      boolean boolean0 = fixedOrderComparator0.addAsEqual("", 2);
      assertTrue(boolean0);
      assertEquals(2, fixedOrderComparator0.getUnknownObjectBehavior());
  }
  ...
  public void test24()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior((-4042));
        fail("Expecting exception: IllegalArgumentException");
